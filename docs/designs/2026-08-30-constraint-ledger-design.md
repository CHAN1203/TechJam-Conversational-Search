...
### Stage 0: correctness fixes on the existing structure (E24-A) -- MEASURED, REJECTED
...
### Stage 1: the constraint ledger and query projection (E24-B) -- MEASURED, RETAINED
...
### Stage 2: weighted projection and an information-gain stop (E24-C) -- MEASURED, SPLIT
