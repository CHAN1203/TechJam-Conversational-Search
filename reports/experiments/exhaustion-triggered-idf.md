# E25-B: Exhaustion-Triggered Catalog IDF
...
information-gain counter from E24-C. The reasoning was that while information
...
change which hundred candidates enter the pool. E25-B measures that **weighting**
...
removed; `starter/agent.py` is byte-identical to E24-C. The optional `idf`
